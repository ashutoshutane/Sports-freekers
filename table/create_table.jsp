...
try{
	...
	String createQurey="create table users(name varchar(30), email varchar(35) primary key, mobileNumber bigint, password varchar(10), address varchar(100), city varchar(100), state varchar(100), country varchar(100))";
